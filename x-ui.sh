...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/Fpgades/x-ui_Modified/mesh-main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/Fpgades/x-ui_Modified/mesh-main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/Fpgades/x-ui_Modified/mesh-main/x-ui.sh
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/Fpgades/x-ui_Modified/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
